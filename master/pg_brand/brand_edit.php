...
<?
	...
	$bc[] = array('title' => 'Brand Edit', 'url' => '#', 'active' => '1');
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header with-border"><h3 class="box-title">Ubah Brand</h3></div>
          <form action="home.php?act=<?= md5('brand_update')?>" method="post" class="form-horizontal">
            <input type="hidden" name="id_brand" value="<?= $id_brand;?>">
            <div class="box-body">
              <div class="form-group">
                <label for="nm_brand" class="col-sm-2 control-label">Nama Brand</label>
                <div class="col-sm-6">
                  <input type="text" name="nm_brand" class="form-control" value="<?= $r['nm_brand'];?>" required>
                </div>
              </div>
            </div>
