    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <form action="home.php?act=<?php echo md5('surat_jalan_insert')?>" method="post" class="form-horizontal">
            <div class="box-body">
...
function showCell(){
  ...
  doRequested('viewResult'+index,'master/pg_surat_jalan/readCell.php?val='+valBarcode+'&index='+newIndex,false);
}
