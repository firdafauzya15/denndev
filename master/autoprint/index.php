...
if ($_SESSION['id_level'] == '2') {
  $qToko = "AND penjualan.id_toko = '$_SESSION[id_toko]'";
}
...
?>
  <body onload="window.print()">
    <table width="100%">
      <tr><td align="center"><img src="../../upload/<?= $r['file'];?>" height="64" width="64"></td></tr>
      <tr><td align="center" style="font-size: 16px; font-weight: bold;"><?= $r['nm_toko'];?></td></tr>
      <tr><td align="center" style="font-weight: bold;"><?= nl2br($r['alamat']);?></td></tr>
    </table>
    <table width="100%">
      <tr>
...
<?php
  $penjualanUpdate = mysqli_query($link,"UPDATE penjualan SET printed = '1' WHERE nota = '$r[nota]'") or die(mysqli_error());
  break; 
}
?>
</html>