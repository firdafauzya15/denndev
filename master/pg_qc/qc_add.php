      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah QC CMT</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('qc_insert')?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="box-body">
                  ...
                  <select class="form-control select2" name="id_cmt" required id="id_cmt">
                    <?php
                      ...
                      while ($cmt = mysqli_fetch_array($cmts)) {
                        echo "<option value='$cmt[id_cmt]'>$cmt[nm_cmt]</option>";
                      }
                    ?>
                  </select>
                </div>
