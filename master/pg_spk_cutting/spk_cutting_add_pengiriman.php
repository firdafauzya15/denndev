      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Pengiriman SPK Cutting</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('spk_cutting_insert_pengiriman')?>" method="post" class="form-horizontal">
            <div class="box-body">
...
function showCell(){
  ...
  doRequested('viewResult'+index,'master/pg_spk_cutting/readCell_pengiriman.php?val='+valBarcode+'&index='+newIndex,false);
}
 ...
 $(document).ready(function() {
  ...
  var availableAttributes = [
          ...
          while($rB = mysqli_fetch_array($qB)){
            echo "'" . $rB['kd_produk_size'] . " | " . $rB['nm_model'] . " | " . $rB['nm_produk'] . "',";
          }
          ?>
  ];
