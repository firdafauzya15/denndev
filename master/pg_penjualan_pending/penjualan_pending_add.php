      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Penjualan Pending</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('penjualan_pending_add')?>" method="post" class="form-horizontal">
            <div class="box-body">
          ...
          <form action="home.php?act=<?php echo md5('penjualan_pending_add_preview')?>" method="post" class="form-horizontal">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="jatuh_tempo" class="form-control pull-right"  readonly="readonly" required value="<?= date('Y-m-d');?>">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                  </div>
