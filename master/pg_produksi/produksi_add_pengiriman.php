...
$nota_sablon = base64_decode($_GET['nota_sablon']);
?>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Balikan CMT</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('produksi_insert_pengiriman')?>" method="post" class="form-horizontal">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Nota Sablon</label>
                <div class="col-sm-3">
                  <input type="text" name="nota_sablon" value="<?= $nota_sablon;?>" class="form-control" required readonly="readonly">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <table class="table table-bordered" style="margin-bottom: -3px;">
                    <tr>
                      ...
                      <td width="10%">Pcs</td>
                      <td width="10%">Sisa Lusin</td>
                      <td width="10%">Sisa Pcs</td>
                      <td width="5%">Aksi</td>
                    </tr>                  
                  </table>
                  <div id="viewResult0">
...
function showCell(){
  ...
  doRequested('viewResult'+index,'master/pg_produksi/readCell_pengiriman.php?nota='+valNota+'&val='+valBarcode+'&index='+newIndex,false);
}
