      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Pengiriman Reject Produksi</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('produksi_insert_pengiriman_bs')?>" method="post" class="form-horizontal">
            <div class="box-body">
