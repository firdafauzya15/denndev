...
$id_customer = base64_decode($_GET['id_customer']);
$q = mysqli_query($link,"SELECT * FROM customer WHERE id_customer = '$id_customer'");
$r = mysqli_fetch_array($q);
?>
<div class="content-wrapper">
<?
 	$bc[] = array('title' => 'Customer', 'url' => 'home.php?act='.md5('customer'), 'active' => '0');
	$bc[] = array('title' => 'Customer Edit', 'url' => '#', 'active' => '1');
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          <div class="box-header with-border"><h3 class="box-title">Ubah customer</h3></div>
          <form action="home.php?act=<?= md5('customer_update')?>" method="post" class="form-horizontal">
            <input type="hidden" name="id_customer" value="<?= $id_customer;?>">
            <div class="box-body">
              <div class="form-group">
                <label for="nm_customer" class="col-sm-2 control-label">Nama customer</label>
                <div class="col-sm-6">
                  <input type="text" name="nm_customer" class="form-control" value="<?= $r['nm_customer'];?>" required>
                </div>
              </div>
              <div class="form-group">
