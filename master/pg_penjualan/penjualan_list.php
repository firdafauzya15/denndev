                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="?act=<?php echo md5('penjualan_detail')."&nota=$nota"?>"><i class="fa fa-eye"></i>Detail</a></li>
                          <?php
                          if ($_SESSION['id_level'] == '1') {
                          ?>
                            <li><a href="?act=<?php echo md5('penjualan_delete')."&nota=$nota&id_toko=$id_toko"?>" onclick="return confirm('Apakah anda yakin ?')"><i class="fa fa-trash"></i>Hapus</a></li>
                          <?php
                          }
                          ?>
                        </ul>
