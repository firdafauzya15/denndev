...
$q = mysqli_query($link,"SELECT 
                      penjualan.nota, 
                      if(penjualan.nota_retur IS NULL, '-', penjualan.nota_retur) AS nota_retur, 
	          ...
	          <div class="row">
                  ...
                  <tr>
                    ...
                    <td><?= $rP['keterangan'];?></td>
			          	...
			          	<tr>
			          		<td></td>
			          		<td><a class="btn btn-warning" target="blank" href="master/pg_penjualan/print_penjualan.php?id=<?= $_GET['nota'];?>"><i class="glyphicon glyphicon-print icon-white"></i> Print</a></td>
			          	</tr>
			          </table>
		          </div>
	          </div>
	          ...
	          <div class="row">
		          <div class="col-md-12">
                    ...
                    <td>Lusin</td>
		              ...
		              ?>
                        ...
                        <td><?= number_format(lusin($r['jumlah']));?></td>
                            ...
                            ?>
                              <a href="?act=<?php echo md5('penjualan_delete_item')."&id_penjualan_detail=$id_penjualan_detail&id_toko=$id_toko"?>" class="btn btn-xs btn-danger" title="Hapus Item"  onclick="return confirm('Apakah anda yakin ?')"><i class="fa fa-trash"></i></a>
                            <?php
                            }
                            ?>
                        </td>
					        ...
					        <?php
						      	...
						      	$diskon = $rP['diskon'];
						      	$grandtotal = $total + $pajak - $diskon - $rP['total_retur'] + $rP['ongkir'];
                    ...
                    <tr>
                      <td colspan="5"></td>
                      <td>Retur</td>
                      <td><?= number_format($rP['total_retur']);?></td>
                    </tr>
