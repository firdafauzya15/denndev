<?php
  ...
  $totalRetur = 0;
  $returPenjualans = mysqli_query($link,"SELECT
    retur_penjualan_detail.harga_jual*retur_penjualan_detail.jumlah AS subtotal
    FROM 
    retur_penjualan_detail 
    WHERE retur_penjualan_detail.nota = '$nota_retur'
    ") or die (mysqli_error());
  while ($returPenjualan = mysqli_fetch_array($returPenjualans)) {
    $totalRetur += $returPenjualan['subtotal'];
  }
?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <form action="home.php?act=<?php echo md5('penjualan_insert')?>" method="post" class="form-horizontal">
            <input type="hidden" name="id_toko" value="<?= $id_toko;?>">
            <input type="hidden" name="id_customer" value="<?= $id_customer;?>">
            <input type="hidden" name="tanggal" value="<?= $tanggal;?>">
            <input type="hidden" name="jatuh_tempo" value="<?= $jatuh_tempo;?>">
            <input type="hidden" name="nota_retur" value="<?= $nota_retur;?>">
            <input type="hidden" name="total_retur" value="<?= $totalRetur;?>">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" name="Toko" class="form-control pull-right" required value="<?= $nota_retur;?>" readonly="readonly">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <table class="table table-bordered" style="margin-bottom: -3px;">
                    ...
                    <tr>
                      ...
                      <input type="hidden" name="total_retur" id="total_retur" value="<?= $totalRetur;?>">
                    </tr>
                    <tr style="font-weight: bold;">
                      <td colspan="7"></td>
                      <td>Grand Total</td>
                      <td id="grandtotal"><?= number_format($total-$totalRetur);?></td>
                      <input type="hidden" name="grandtotal" id="grandtotal_form" value="<?= $total-$totalRetur;?>">
                    </tr>
                  </table>
                </div>
              </div><!-- /.form-group -->
...
function count_pajak(e) {
  ...
  var grandtotal_form = parseInt(document.getElementById("total").value) - parseInt(document.getElementById("total_retur").value) + parseInt(pajak);
