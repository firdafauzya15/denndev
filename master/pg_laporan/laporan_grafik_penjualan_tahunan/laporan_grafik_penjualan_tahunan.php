...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Data Laporan Grafik Penjualan Tahunan
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="box">
          <div class="box-body">
            <form action="#" method="get" class="form-horizontal">
              <input type="hidden" name="act" value="<?= md5("laporan_grafik_penjualan_tahunan");?>">
              <div class="row">
                <div class="col-md-2">
            ...
            if ($_GET['tahun'] != "") {
              $grandTotals = [];
              $range = 12;
              for($currentMonth = 1; $currentMonth <= $range; $currentMonth++) {
                  $total_omset = 0;
                  $penjualans = mysqli_query($link,"SELECT
                    ...
                    penjualan 
                    WHERE
                    year(penjualan.tanggal) = '$_GET[tahun]' AND month(penjualan.tanggal) = '$currentMonth'
                  ") or die (mysqli_error());
                  while ($penjualan = mysqli_fetch_array($penjualans)) {
                    $omset = 0;
