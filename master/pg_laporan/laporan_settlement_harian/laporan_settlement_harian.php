...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Data Laporan Settlement Harian
    </h1>
    <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Settlement Harian</li>
    </ol>
  </section>
        ...
        <div class="box">
          <div class="box-body">
            <form action="#" method="get" class="form-horizontal">
              <input type="hidden" name="act" value="6a595cb50208867b5c31c246206496f5">
              <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">
              <div class="col-md-4">
                <table class="table">
                  ...
                  while ($metode = mysqli_fetch_array($metodes)) {
                    ...
                    $rows .= "<td width='1'><b>".number_format($grandTotalMetode,0,',','.')."</b></span></td>";
                    $rows .= "</tr>";
                    echo "$rows";
                  }
                  ?>
              ...
              <div class="col-md-4">
                <table class="table">
                  ...
                  while ($metode = mysqli_fetch_array($metodes)) {
                    ...
                    $rows = "<tr>";
                    $rows .= "<td>$metode[nm_metode]</td>";
                    $rows .= "<td width='1'><b>".number_format($grandTotalMetode,0,',','.')."</b></td>";
                    $rows .= "</tr>";
                    echo "$rows";
                  }
                  ?>
              ...
              <div class="col-md-4">
                <a class="btn btn-warning" href="#" onClick="MyWindow=window.open('master/pg_laporan/laporan_settlement_harian/print_laporan_settlement_harian.php<?= $paramsSearch;?>','MyWindow','width=794,height=842'); return false;"><i class="glyphicon glyphicon-print icon-white"></i> Print</a>
              </div>
            </div>
            <hr>
